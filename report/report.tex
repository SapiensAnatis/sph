...
This test also features a random distribution of particles and a constant smoothing length ($h = 0.3$). Figure \ref{fig:density_time} is a plot showing the results of this test. 
